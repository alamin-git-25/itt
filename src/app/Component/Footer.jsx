...
const Footer = () => {
    return (
        <div className='relative overflow-hidden'>
            <div className='w-full h-full  bg-[#000214] absolute z-[-1]'>
                <div className='bg-indigo-800/50 w-[1000px] h-[800px] rounded-full bottom-[-550px] absolute left-[-100px]'></div>
                <div className='bg-indigo-800/50 w-[800px] h-[800px] rounded-full top-[-550px] absolute right-0'></div>
            </div>
            <footer className="w-full ">
                {/*      <!-- Main footer --> */}
                <div className="pt-16 pb-12 grid lg:grid-cols-3 grid-cols-1 gap-10 place-items-center border-t z-[1] border-slate-900 fot px-10">
                    <div className='lg:border-none border-b'>
                        <nav
                            className="col-span-2 md:col-span-4 lg:col-span-3"
                            aria-labelledby="footer-product-dark"
                        >
                            <h3
                                className="mb-6 text-2xl font-thin text-white"
                            ...
                            <ul>
                                <li className="mb-2 leading-6">
                                    <p className="text-slate-100 font-thin text-xl">
                                        24-25 Dilkusha C/A (4th floor), Motijheel Dhaka-1000.,<br /> Dhaka, Bangladesh
                                    </p>
                                </li>
                                <li className="mb-2 leading-6">
                                    <p className="text-slate-100 font-thin text-xl">
                                        Email : insaftravelandtours@gmail.com
                                    </p>
                                </li>
                                <li className="mb-2 leading-6">
                                    <p

                                        className="text-slate-100 font-thin text-xl"
                                    >
                                        Contact : +8801646-928510
                                    </p>
                                </li>
                            </ul>
                        </nav>
